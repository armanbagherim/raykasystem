...
export default function Orders() {
  ...
  const fetchTotal = async () => {
    ...
    let url = `/v1/api/ecommerce/report/couriers/total?beginDate=${reportProps.startDate}&endDate=${reportProps.endDate}`;
  ...
  let url = `${process.env.NEXT_PUBLIC_BASE_URL}/v1/api/ecommerce/report/couriers?beginDate=${reportProps.startDate}&endDate=${reportProps.endDate}`;
