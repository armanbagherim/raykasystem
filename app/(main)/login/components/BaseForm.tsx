  ...
  return (
    <div className="container mx-auto">
      <div className="login">
        ...
        <div className="">
          <div className="h-full md:flex lg:flex xl:flex 2xl:flex shadow-shadowCustom justify-center border border-[#F1F1F1] rounded-[25px]">
            <div className="flex-1 flex justify-center items-center py-2 md:py-40 lg:py-40 xl:py-40 2xl:py-40">
              <div className="text-center pr-3 pl-3">
                ...
                {state == "phone" && (
                  <div className="text-right mr-5 ml-5 md:m-0 lg:m-0 xl:m-0 2xl:m-0">
            ...
            <div className="flex-1 pr-3 pl-3 lg:p-0">
              <div className="wrapper flex flex-col justify-between md:rounded-e-[25px] lg:rounded-e-[25px] xl:rounded-e-[25px] 2xl:rounded-e-[25px] h-full text-white bg-gradiant-login px-8 py-11">
                <div>
